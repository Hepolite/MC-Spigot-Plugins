package com.hepolite.kineticore.util;
...
public final class StringConverter
{
	...
	private static final <T> ArrayList<T> toGenerics(final String string,
		final T def, final String regex,
		final BiFunction<String, T, T> converter)
	{
		final ArrayList<T> data = new ArrayList<>();
		for (final String part : string.split(regex))
			data.add(converter.apply(part, def));
		return data;
	}
	...
	/**
	 * Converts the given string to a boolean value, if possible. If the string
	 * could not be converted, the default value {@code false} is returned.
	 * 
	...
	/**
	 * Converts the given string to an array of boolean values. If any element
	 * of the string could not be converted, the default value {@code false} is
	 * used.
	 * 
	...
	/**
	 * Converts the given string to an array of boolean values. If any element
	 * of the string could not be converted, the default value is used.
	 * 
	 * @param string The string to convert to boolean values
	 * @param def The default value if the string could not be converted
	 * @param regex The regex separating two values from each other
	 * @return The boolean array of the string values
	 */
	public static boolean[] toBools(final String string, final boolean def,
		final String regex)
	{
		return ArrayUtils
			.toPrimitive(toGenerics(string, def, regex, StringConverter::toBool)
				.toArray(new Boolean[0]));
	}

	/**
	 * Converts the given string to a byte value, if possible. If the string
	 * could not be converted, the default value {@code 0} is returned.
	 * 
	...
	/**
	 * Converts the given string to an array of byte values. If any element of
	 * the string could not be converted, the default value {@code 0} is used.
	 * 
	...
	/**
	 * Converts the given string to an array of byte values. If any element of
	 * the string could not be converted, the default value is used.
	 * 
	 * @param string The string to convert to byte values
	 * @param def The default value if the string could not be converted
	 * @param regex The regex separating two values from each other
	 * @return The byte array of the string values
	 */
	public static byte[] toBytes(final String string, final byte def,
		final String regex)
	{
		return ArrayUtils
			.toPrimitive(toGenerics(string, def, regex, StringConverter::toByte)
				.toArray(new Byte[0]));
	}

	/**
	 * Converts the given string to a double value, if possible. If the string
	 * could not be converted, the default value {@code 0} is returned.
	 * 
	...
	/**
	 * Converts the given string to an array of double values. If any element of
	 * the string could not be converted, the default value {@code 0} is used.
	 * 
	 ...
	 * @return The double array of the string values
	 */
	public static double[] toDoubles(final String string, final double def,
		final String regex)
	{
		return ArrayUtils.toPrimitive(
			toGenerics(string, def, regex, StringConverter::toDouble)
				.toArray(new Double[0]));
	}

	/**
	 * Converts the given string to a float value, if possible. If the string
	 * could not be converted, the default value {@code 0} is returned.
	 * 
	...
	/**
	 * Converts the given string to an array of float values. If any element of
	 * the string could not be converted, the default value {@code 0} is used.
	 * 
	 ...
	 * @return The float array of the string values
	 */
	public static float[] toFloats(final String string, final float def,
		final String regex)
	{
		return ArrayUtils.toPrimitive(
			toGenerics(string, def, regex, StringConverter::toFloat)
				.toArray(new Float[0]));
	}

	/**
	 * Converts the given string to a integer value, if possible. If the string
	 * could not be converted, the default value {@code 0} is returned.
	 * 
	...
	/**
	 * Converts the given string to an array of integer values. If any element
	 * of the string could not be converted, the default value {@code 0} is
	 * used.
	 * 
	 ...
	 * @return The integer array of the string values
	 */
	public static int[] toInts(final String string, final int def,
		final String regex)
	{
		return ArrayUtils
			.toPrimitive(toGenerics(string, def, regex, StringConverter::toInt)
				.toArray(new Integer[0]));
	}

	/**
	 * Converts the given string to a long value, if possible. If the string
	 * could not be converted, the default value {@code 0} is returned.
	 * 
	...
	/**
	 * Converts the given string to an array of long values. If any element of
	 * the string could not be converted, the default value {@code 0} is used.
	 * 
	 ...
	 * @return The long array of the string values
	 */
	public static long[] toLongs(final String string, final long def,
		final String regex)
	{
		return ArrayUtils
			.toPrimitive(toGenerics(string, def, regex, StringConverter::toLong)
				.toArray(new Long[0]));
	}

	/**
	 * Converts the given string to a short value, if possible. If the string
	 * could not be converted, the default value {@code 0} is returned.
	 * 
	...
	/**
	 * Converts the given string to an array of short values. If any element of
	 * the string could not be converted, the default value {@code 0} is used.
	 * 
	 ...
	 * @return The short array of the string values
	 */
	public static short[] toShorts(final String string, final short def,
		final String regex)
	{
		return ArrayUtils.toPrimitive(
			toGenerics(string, def, regex, StringConverter::toShort)
				.toArray(new Short[0]));
	}

	/**
	 * Converts the given string to a string value, if possible. If the string
	 * is null, the default value {@code ""} is returned.
	 * 
	...
	/**
	 * Converts the given string to an array of string values. If any element of
	 * the string could not be converted, the default value {@code 0} is used.
	 * 
	 ...
	 * @return The string array of the string values
	 */
	public static String[] toStrings(final String string, final String def,
		final String regex)
	{
